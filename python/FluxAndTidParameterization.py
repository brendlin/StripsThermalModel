...
version = Config.GetStr('FluxAndTidParameterization.ModelVersion','S3.1Q6',description='Flux and TID model version')
...
def GetFluxEndcap(ring,disk) :
    ...
    print 'Error - version %s not recognized for FluxAndTidParameterization. Exiting'%(version)
    import sys; sys.exit()
    return None
