...
lpgbtI = Config.GetDouble('EOSComponents.lpgbtI',0.317,unit='A',description=descr_lpgbtI)*(1 + SafetyFactors.safetycurrentd)
...
gbld25I = Config.GetDouble('EOSComponents.gbld25I',0.07,unit='A',description=descr_gbld25I)*(1 + SafetyFactors.safetycurrentd)
descr_gbld12I = 'Current in GBLD10 1.2V circuit'
gbld12I = Config.GetDouble('EOSComponents.gbld12I',0.025,unit='A',description=descr_gbld12I)*(1 + SafetyFactors.safetycurrentd)
